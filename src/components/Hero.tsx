        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-tight">
              <span className="block bg-gradient-to-r from-white via-[#8B5CF6] to-white bg-clip-text text-transparent">
                SECURING
              </span>
              <span className="block bg-gradient-to-r from-[#8B5CF6] via-[#A855F7] to-[#EC4899] bg-clip-text text-transparent">
                THE UNSEEN
              </span>
            </h1>
          ...
          {/* CTA Button */}
          <div className="pt-8">
            <button className="group bg-gradient-to-r from-[#8B5CF6] to-[#EC4899] hover:from-[#A855F7] hover:to-[#F472B6] text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 flex items-center mx-auto space-x-2">
